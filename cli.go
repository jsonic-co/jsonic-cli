...
import (
	...
	mets "github.com/jsonic-co/jsonic-cli/methods"
...
func main() {
	...
	app.Commands = []cli.Command{
		...
		{
			Name:  "send",
			Usage: "Test all the Endpoints in the Jsonic Collection.json",
			Action: func(c *cli.Context) error {
		...
		{
			Name:  "gen",
			Usage: "Generate Documentation from the Jsonic Collection.json",
			Flags: genFlags,
			Action: func(c *cli.Context) error {
	...
	CREATE A NEW ISSUE FOR BUGS AND FEATURE REQUESTS : < https://github.com/jsonic-co/jsonic-cli >
